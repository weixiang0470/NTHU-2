...
#define ARMA_AUX_LIBS /usr/lib64/libopenblaso.so;/disk1/2025DA1/group4/projects/p2/Gordian_Placement/Assignment2/third_party/openblas/lib/libopenblas.so;/usr/lib64/libarpack.so;/usr/lib64/libsuperlu.so
