::namespace eval ::pct::build {
  ...
  proc callback {args} {
    ...
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/home/HardwareSecurity_1132/tsx1136010/HW03/PA3/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
