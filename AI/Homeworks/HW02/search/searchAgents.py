...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState: pacman.GameState):
        ...
        self.initialState = [0,0,0,0] # all corners not visited
    ...
    def isGoalState(self, state: Any):
        ...
        "*** YOUR CODE HERE ***"
        for item in state[1]:
            if item == 0: # if one corner is not visited
                return False
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                if (nextx,nexty) in self.corners:
                    corn[self.corners.index((nextx,nexty))] = 1 # Visit the corner

                nextState = ((nextx, nexty),corn) # New state
                # cost = 1
    ...
    if problem.isGoalState(state):
        ...
        for index,item in enumerate(state[1]):
            if item == 0: # Not visited corner
                ...
                dis = manhattanDistance(state[0],corners[index])
                ...
                distancesFromGoals.append(dis)
        # print(distancesFromGoals)
    return max(distancesFromGoals) # Default to trivial solution
